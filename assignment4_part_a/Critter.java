...
public abstract class Critter {
	...
	public static void worldTimeStep() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		while(iterator1.hasNext()){
			...
			if(c.dead==true) critterCollection.remove(critterCollection.indexOf(c));
		}
		critterCollection.addAll(babies);

	}

	public static void doEncounter(Critter A, Critter B) {
